      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl space-y-3 mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-[#5E524E] font-medium">
            Sinergia interdisciplinaria entre el Derecho y la Administración Pública.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {PROFILE_DATA.education.map((edu) => (
            <div
              key={edu.id}
              className={`p-7 sm:p-9 rounded-3xl border transition-all duration-300 flex flex-col justify-between ${
            ...
            >
              <div className="space-y-5">
                ...
                {/* Highlights List */}
                <div className="space-y-2 pt-3 border-t border-[#EADDD8]">
              ...
              <div className="mt-8 pt-4 border-t border-[#EADDD8] flex items-center justify-between text-xs font-extrabold text-[#181412]">
