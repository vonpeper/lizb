...
import { GraduationCap, Scale, Landmark, ShieldCheck, Sparkles, CheckCircle2, ArrowRight } from "lucide-react";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          {/* Bento 1: Large Interactive Mode Switcher (Span 8) */}
          <div className="md:col-span-12 lg:col-span-8 p-6 sm:p-8 rounded-3xl bg-[#FFFDFC] border border-[#EADDD8] hover:border-[#E88771] transition-all duration-300 shadow-card flex flex-col justify-between">
            <div>
              {/* Interactive Tabs */}
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                <div className="space-y-2.5 pt-2">
                  {currentMode.bullets.map((bullet, bIdx) => (
                    <div
                      key={bIdx}
                      className="p-3 rounded-2xl bg-[#FFF6F2] border border-[#EADDD8] flex items-start gap-3 text-xs sm:text-sm font-medium text-[#181412]"
                    >
            ...
            <div className="mt-8 pt-4 border-t border-[#EADDD8] flex items-center justify-between text-xs font-bold text-[#5E524E]">
              <span>Villa de Allende & Toluca</span>
              <span className="text-[#B94F3D]">Licenciatura (ISIMA) + Maestría (UVM)</span>
            </div>
          </div>

          {/* Bento 2: Sindicatura Municipal Live Card (Span 4) */}
          <div className="md:col-span-12 lg:col-span-4 p-6 sm:p-8 rounded-3xl bg-[#181412] text-white flex flex-col justify-between shadow-floating group">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 text-[11px] font-extrabold">
              ...
              <div className="space-y-2 pt-2 border-t border-white/10">
                <div className="text-xs text-[#A89D97] flex items-center gap-2">
            ...
            <div className="pt-5 mt-4 border-t border-white/10 flex items-center justify-between text-xs text-[#F6B6A6] font-bold">
          ...
          <div className="md:col-span-6 p-6 sm:p-8 rounded-3xl bg-[#FFFDFC] border border-[#EADDD8] hover:border-[#E88771] transition-all duration-300 shadow-card flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
              ...
              <p className="text-xs text-[#5E524E] leading-relaxed font-medium">
                Especialización en finanzas gubernamentales, planeación y control administrativo institucional.
              </p>
            </div>

            <div className="pt-4 mt-4 border-t border-[#EADDD8] flex items-center justify-between text-xs font-extrabold text-[#181412]">
              <span>Periodo: 2025–Presente</span>
              <span className="text-[#B94F3D]">UVM Metepec</span>
            </div>
          </div>

          {/* Bento 4: Licenciatura y Litigio (Span 6) */}
          <div className="md:col-span-6 p-6 sm:p-8 rounded-3xl bg-[#FFFDFC] border border-[#EADDD8] hover:border-[#E88771] transition-all duration-300 shadow-card flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-[#FFE4DC] border border-[#EADDD8] flex items-center justify-center text-[#B94F3D]">
